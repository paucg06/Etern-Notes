...
- **🎨 Interfaz Oscura y Moderna**: Diseño elegante y cuidado al detalle para evitar la fatiga visual.
- **⚡ Ligero y Standalone**: Sin dependencias pesadas, compilado directamente en C# / WPF.

---

## 🚀 Compilación y Ejecución

Si deseas compilar el proyecto en tu máquina local:
